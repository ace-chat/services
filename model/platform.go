...
type Platform struct {
	...
	Type      int            `gorm:"column:type;type:int(10);comment:platform type:1 Social Media Ads,2 Search Engine Ads, 3 business chat bot" json:"type"`
	...
	Status    bool           `gorm:"column:status;comment:platform status, only for business chat bot" json:"status"`
